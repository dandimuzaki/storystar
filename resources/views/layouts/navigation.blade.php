        ...
        <div class="flex justify-between h-16 items-center lg:gap-16 gap-6">
            ...
            <form class="flex-1" method="get" action="{{ route('result') }}">
                <div class="flex w-full">
                    ...
                    <button type="submit"
                        class="flex justify-center items-center rounded-r-lg border-r border-y border-gray-500 w-12">
                        <x-zondicon-search class="w-5" />
                    </button>
                </div>
            </form>
            ...
            <div class="flex lg:gap-4 gap-2 items-center w-fit">
                @auth
                    ...
                    <!-- Settings Dropdown -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6 z-999">
                        <x-dropdown align="right" width="48" class="z-999">
                            <x-slot name="trigger">
                                <button
                            ...
                            <x-slot name="content" class="z-999">
                                <x-dropdown-link :href="route('profile.edit')">
                                    {{ __('Profile') }}
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('mypost', Auth::user()->username)">
                                    {{ __('My Posts') }}
                                </x-dropdown-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            @auth
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('mypost', Auth::user()->username)">
                        {{ __('My Posts') }}
                    </x-responsive-nav-link>
